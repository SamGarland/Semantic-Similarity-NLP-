...
# It is interesting to note that, when runnning the file with 'en_core_web_sm' instead of 'en_core_web_md', the sematic similarity drops
# by at least 1 or 2 decimal points with each comparison. Presumably, the training data in 'en_core_web_md' gives much more precision when
